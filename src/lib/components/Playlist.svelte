<script lang="ts">
  ...
  <div class="w-full min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-rose-900 via-rose-100 to-rose-900 dark:bg-gradient-to-br dark:from-rose-900 dark:via-black dark:to-rose-900">
