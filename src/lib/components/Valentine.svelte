	...
	>
		...
		>
			<div class="typing-animation">
				...
				<p
					class="bg-gradient-to-r from-pink-700 via-pink-500 to-pink-200 bg-clip-text text-4xl leading-10 font-bold text-transparent md:text-6xl"
				>
					Be My Valentine?
				</p>
				<p class="mt-0.5 text-xl text-black text-shadow-md md:text-3xl dark:text-white">
					...please?
				</p>
				<p class="mt-0.5 text-xl text-black text-shadow-md md:text-3xl dark:text-white">
					I love you &lt;3
