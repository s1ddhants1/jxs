...
<div class="font-[LondonBetween] font-bold text-nowrap flex fixed p-40 z-20 w-full items-center justify-center"> 
  <div class="typing-animation">
    <p class="text-xl md:text-3xl mt-1 text-black dark:text-white">heyy nini!!</p>
    <p class="text-xl md:text-3xl mt-1 text-black dark:text-white">would you like to...</p>
    ...
    <p class="text-xl md:text-3xl mt-1 text-black dark:text-white">...please?</p>
    <p class="text-xl md:text-3xl mt-1 text-black dark:text-white">I love you &lt;3</p>
  </div>
</div>
</section>
