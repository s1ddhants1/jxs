...
<section class="flex min-h-screen w-full flex-col items-center justify-center rounded-xl p-4">
	<div bind:this={sectionRef} class="relative h-screen w-full overflow-hidden">
		...
		<!-- Center content -->
		<div
			class="absolute top-1/2 left-1/2 z-20 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center text-center opacity-0 transition-all delay-[1200ms] duration-1000 ease-out"
